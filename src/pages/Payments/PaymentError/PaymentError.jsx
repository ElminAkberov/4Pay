  ...
  return (
    <menu className="flex items-center justify-center w-full p-[20px]">
      <div className="w-full px-2">
        <div className="w-full grid min-[1400px]:grid-cols-7 max-[1400px]:flex-col gap-x-3 items-center">
          ...
          <button className=" w-full hover:bg-[#0dcaf0] hover:text-black px-[12px] py-[6px] border border-[#0dcaf0] text-[#0dcaf0] rounded-sm  mt-2 mb-4 duration-200 cursor-pointer">
          Скачать данные
          </button>
        </div>
        <PaymentErrorTable />
